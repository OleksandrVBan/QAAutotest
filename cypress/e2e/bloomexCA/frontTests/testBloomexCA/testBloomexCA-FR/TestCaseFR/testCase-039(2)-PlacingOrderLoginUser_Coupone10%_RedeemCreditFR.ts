...
describe("Test case №39(2) -PlacingOrder-LogginUser-RedeemCredit-with using Coupon-FR", () => {

    it("PlacingOrder-LogginUser-RedeemCredit-with using Coupon-FR-Test case №39(2)", () => {
        ...
        CheckoutFR.fillSecondStepRedeemCredit();
